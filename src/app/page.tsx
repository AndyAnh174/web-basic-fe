  ...
  return (
    <Layout>
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 className="mb-4 text-4xl font-heading font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          Cuộc thi Phát triển Web
        </h1>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">
          Thử thách bản thân, nâng cao kỹ năng và khám phá tiềm năng của bạn trong lĩnh vực phát triển web
        </p>
